...
CPXLIBAPI
CPXINT CPXPUBLIC
   CPXLgetnumobjs (CPXCENVptr env, CPXCLPptr lp);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetparamhiername (CPXCENVptr env, int whichparam,
                         char *name_str);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLmodelasstcallbackgetfunc (CPXCENVptr env, CPXCLPptr lp,
...
CPXLIBAPI
int CPXPUBLIC
   CPXLmodelasstcallbacksetfunc (CPXENVptr env, CPXLPptr lp,
...
CPXLIBAPI
int CPXPUBLIC
   CPXLmultiobjchgattribs (CPXCENVptr env, CPXLPptr lp, CPXINT objind,
...
CPXLIBAPI
int CPXPUBLIC
   CPXLmultiobjgetcntinfo (CPXCENVptr env, CPXCLPptr lp,
                           CPXINT subprob, CPXLONG *info_p, int what);


CPXLIBAPI
int CPXPUBLIC
   CPXLmultiobjgetdblinfo (CPXCENVptr env, CPXCLPptr lp,
                           CPXINT subprob, double *info_p, int what);


CPXLIBAPI
int CPXPUBLIC
   CPXLmultiobjgetdiminfo (CPXCENVptr env, CPXCLPptr lp,
                           CPXINT subprob, CPXINT *info_p, int what);


CPXLIBAPI
int CPXPUBLIC
   CPXLmultiobjgetindex (CPXCENVptr env, CPXCLPptr lp,
                         char const *name, CPXINT *index_p);


CPXLIBAPI
int CPXPUBLIC
   CPXLmultiobjgetintinfo (CPXCENVptr env, CPXCLPptr lp,
                           CPXINT subprob, int *info_p, int what);


CPXLIBAPI
int CPXPUBLIC
   CPXLmultiobjgetlonginfo (CPXCENVptr env, CPXCLPptr lp,
                            CPXINT subprob, CPXLONG *info_p, int what);


CPXLIBAPI
int CPXPUBLIC
   CPXLmultiobjgetname (CPXCENVptr env, CPXCLPptr lp, CPXINT objind,
                        char *buf_str, CPXSIZE bufspace,
                        CPXSIZE *surplus_p);
...
CPXLIBAPI
CPXINT CPXPUBLIC
   CPXLmultiobjgetnumsolves (CPXCENVptr env, CPXCLPptr lp);


CPXLIBAPI
int CPXPUBLIC
   CPXLmultiobjgetobj (CPXCENVptr env, CPXCLPptr lp, CPXINT n,
...
CPXLIBAPI
int CPXPUBLIC
   CPXLmultiobjgetobjval (CPXCENVptr env, CPXCLPptr lp, CPXINT n,
                          double *objval_p);


CPXLIBAPI
int CPXPUBLIC
   CPXLmultiobjgetobjvalbypriority (CPXCENVptr env, CPXCLPptr lp,
                                    CPXINT priority, double *objval_p);


CPXLIBAPI
int CPXPUBLIC
   CPXLmultiobjopt (CPXCENVptr env, CPXLPptr lp,
                    CPXCPARAMSETptr const *paramsets);


CPXLIBAPI
int CPXPUBLIC
   CPXLmultiobjsetobj (CPXCENVptr env, CPXLPptr lp, CPXINT n,
...
CPXLIBAPI
int CPXPUBLIC
   CPXLparamsetadddbl (CPXCENVptr env, CPXPARAMSETptr ps,
                       int whichparam, double newvalue);


CPXLIBAPI
int CPXPUBLIC
   CPXLparamsetaddint (CPXCENVptr env, CPXPARAMSETptr ps,
                       int whichparam, CPXINT newvalue);


CPXLIBAPI
int CPXPUBLIC
   CPXLparamsetaddlong (CPXCENVptr env, CPXPARAMSETptr ps,
                        int whichparam, CPXLONG newvalue);


CPXLIBAPI
int CPXPUBLIC
   CPXLparamsetaddstr (CPXCENVptr env, CPXPARAMSETptr ps,
                       int whichparam, char const *svalue);


CPXLIBAPI
int CPXPUBLIC
   CPXLparamsetapply (CPXENVptr env, CPXCPARAMSETptr ps);


CPXLIBAPI
int CPXPUBLIC
   CPXLparamsetcopy (CPXCENVptr targetenv, CPXPARAMSETptr targetps,
                     CPXCPARAMSETptr sourceps);


CPXLIBAPI
CPXPARAMSETptr CPXPUBLIC
   CPXLparamsetcreate (CPXCENVptr env, int *status_p);


CPXLIBAPI
int CPXPUBLIC
   CPXLparamsetdel (CPXCENVptr env, CPXPARAMSETptr ps, int whichparam);


CPXLIBAPI
int CPXPUBLIC
   CPXLparamsetfree (CPXCENVptr env, CPXPARAMSETptr *ps_p);


CPXLIBAPI
int CPXPUBLIC
   CPXLparamsetgetdbl (CPXCENVptr env, CPXCPARAMSETptr ps,
                       int whichparam, double *dval_p);


CPXLIBAPI
int CPXPUBLIC
   CPXLparamsetgetids (CPXCENVptr env, CPXCPARAMSETptr ps, int *cnt_p,
                       int *whichparams, int pspace, int *surplus_p);


CPXLIBAPI
int CPXPUBLIC
   CPXLparamsetgetint (CPXCENVptr env, CPXCPARAMSETptr ps,
                       int whichparam, CPXINT *ival_p);


CPXLIBAPI
int CPXPUBLIC
   CPXLparamsetgetlong (CPXCENVptr env, CPXCPARAMSETptr ps,
                        int whichparam, CPXLONG *ival_p);


CPXLIBAPI
int CPXPUBLIC
   CPXLparamsetgetstr (CPXCENVptr env, CPXCPARAMSETptr ps,
                       int whichparam, char *sval);


CPXLIBAPI
int CPXPUBLIC
   CPXLparamsetreadcopy (CPXENVptr env, CPXPARAMSETptr ps,
                         char const *filename_str);


CPXLIBAPI
int CPXPUBLIC
   CPXLparamsetwrite (CPXCENVptr env, CPXCPARAMSETptr ps,
                      char const *filename_str);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLsetnumobjs (CPXCENVptr env, CPXCLPptr lp, CPXINT n);

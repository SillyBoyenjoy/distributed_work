...
struct Param {
  ...
  struct MIP {
    ...
    struct SubMIP {
      static const IloCplex::IntParam StartAlg = IntParam(CPX_PARAM_SUBMIPSTARTALG);
      static const IloCplex::IntParam SubAlg = IntParam(CPX_PARAM_SUBMIPSUBALG);
      static const IloCplex::LongParam NodeLimit = LongParam(CPX_PARAM_SUBMIPNODELIMIT);
      static const IloCplex::IntParam Scale = IntParam(CPX_PARAM_SUBMIPSCAIND);
    };
    struct Tolerances {
  ...
  struct MultiObjective {
    static const IloCplex::IntParam Display = IntParam(CPX_PARAM_MULTIOBJDISPLAY);
  };
  struct Network {
  ...
  static const IloCplex::BoolParam ParamDisplay = BoolParam(CPX_PARAM_PARAMDISPLAY);
  struct Preprocessing {
    ...
    static const IloCplex::IntParam Folding = IntParam(CPX_PARAM_FOLDING);
  ...
  struct Read {
    ...
    static const IloCplex::LongParam WarningLimit = LongParam(CPX_PARAM_WARNLIM);
  };
  static const IloCplex::BoolParam Record = BoolParam(CPX_PARAM_RECORD);
  ...
  struct Simplex {
    ...
    static const IloCplex::IntParam DynamicRows = IntParam(CPX_PARAM_DYNAMICROWS);
    struct Limits {
